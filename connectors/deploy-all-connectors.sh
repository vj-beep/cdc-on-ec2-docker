...
deploy_connector() {
  ...
  local envvars='$SQLSERVER_HOST $SQLSERVER_PORT $SQLSERVER_DATABASE $SQLSERVER_USER $SQLSERVER_PASSWORD
    ...
    $SQLSERVER_SOURCE_SNAPSHOT_MODE $SQLSERVER_SOURCE_SNAPSHOT_FETCH_SIZE
    $SQLSERVER_SOURCE_MAX_BATCH_SIZE $SQLSERVER_SOURCE_MAX_QUEUE_SIZE
    $SQLSERVER_SOURCE_MAX_QUEUE_SIZE_IN_BYTES $SQLSERVER_SOURCE_POLL_INTERVAL_MS
    $AURORA_SOURCE_SNAPSHOT_MODE $AURORA_SOURCE_SNAPSHOT_FETCH_SIZE
    $AURORA_SOURCE_MAX_BATCH_SIZE $AURORA_SOURCE_MAX_QUEUE_SIZE
    $AURORA_SOURCE_MAX_QUEUE_SIZE_IN_BYTES $AURORA_SOURCE_POLL_INTERVAL_MS
    $JDBC_SINK_AURORA_BATCH_SIZE $JDBC_SINK_AURORA_TASKS_MAX
    $JDBC_SINK_SQLSERVER_BATCH_SIZE $JDBC_SINK_SQLSERVER_TASKS_MAX'
  local config
