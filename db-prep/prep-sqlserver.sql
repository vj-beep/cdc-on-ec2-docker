...
--
--   * Loop prevention: Only CDC-enable tables that should replicate.
--     Tables without CDC enabled are not captured by Debezium.
-------------------------------------------------------------------------------
...
-- No .env changes needed — Debezium auto-captures all CDC-enabled tables.
